...
public class AchillesOnHitEffect implements OnHitEffectPlugin {
        ...
        public float damageAmount = 25f; //set this to whatever the damage should be
        public float empAmount = 150f; //set this to whatever the EMP damage should be
        ...
        public float volume = 0.45f; //volume, scale from 0-1
