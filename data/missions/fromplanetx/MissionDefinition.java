...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.addToFleet(FleetSide.PLAYER, "ms_neriad_wing", FleetMemberType.FIGHTER_WING, false);
		api.addToFleet(FleetSide.PLAYER, "ms_raksasha_wing", FleetMemberType.FIGHTER_WING, false);
		...
		api.addToFleet(FleetSide.ENEMY, "lasher_CS", FleetMemberType.SHIP, "SHIP IDENT ERROR", false);
		api.addToFleet(FleetSide.ENEMY, "hound_Assault", FleetMemberType.SHIP, "SHIP IDENT ERROR", false);
		api.addToFleet(FleetSide.ENEMY, "hound_Assault", FleetMemberType.SHIP, "SHIP IDENT ERROR", false);
		api.addToFleet(FleetSide.ENEMY, "hound_Assault", FleetMemberType.SHIP, "SHIP IDENT ERROR", false);
...
//		api.addToFleet(FleetSide.ENEMY, "mining_drone_wing", FleetMemberType.FIGHTER_WING, false).getCaptain().setPersonality("suicidal");
		...
		api.addAsteroidField(minY, minY, 65, 4000f,
								20f, 70f, 100);
