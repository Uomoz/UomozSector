package data.missions.randomjunk;
...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		addShip2("enforcer_Assault", 5);
		addShip2("hammerhead_Balanced", 2);
		addShip2("hammerhead_Elite", 2);
		addShip2("astral_Elite", 0);
		addShip2("conquest_Elite", 0);
		addShip2("eagle_Assault", 3);
		addShip2("eagle_Balanced", 2);
		addShip2("falcon_CS", 4);
		addShip2("sunder_CS", 7);
		addShip2("gemini_Standard", 2);
		addShip2("wolf_CS", 8);
		addShip2("hyperion_Strike", 1);
		addShip2("vigilance_Strike", 4);
		addShip2("vigilance_FS", 4);
		addShip2("tempest_Attack", 3);
		addShip2("brawler_Assault", 10);
		addShip2("piranha_wing", 10);
		addShip2("talon_wing", 15);
		addShip2("broadsword_wing", 5);
		addShip2("mining_drone_wing", 10);
		addShip2("wasp_wing", 2);
		addShip2("xyphos_wing", 2);
		addShip2("longbow_wing", 10);
		addShip2("dagger_wing", 1);
		addShip2("thunder_wing", 0);
		addShip2("gladius_wing", 0);
