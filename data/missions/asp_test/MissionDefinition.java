package data.missions.asp_test;
...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.initFleet(FleetSide.PLAYER, "ASP", FleetGoal.ATTACK, false);
		...
		api.addToFleet(FleetSide.PLAYER, "syndicate_asp_diamondback_Standard", FleetMemberType.SHIP, "ASP Bluebell", true);
		api.addToFleet(FleetSide.PLAYER, "syndicate_asp_diamondback_Standard", FleetMemberType.SHIP, false);
		...
		api.addToFleet(FleetSide.PLAYER, "syndicate_asp_venom_wing", FleetMemberType.FIGHTER_WING, false);
		api.addToFleet(FleetSide.PLAYER, "syndicate_asp_constrictor_wing", FleetMemberType.FIGHTER_WING, false);
		api.addToFleet(FleetSide.PLAYER, "syndicate_asp_bite_wing", FleetMemberType.FIGHTER_WING, false);
