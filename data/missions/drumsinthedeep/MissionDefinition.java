...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.addToFleet(FleetSide.PLAYER, "ms_shamash_EMP", FleetMemberType.SHIP, "SYS Ghastly", false, CrewXPLevel.ELITE);
		api.addToFleet(FleetSide.PLAYER, "ms_inanna_CS", FleetMemberType.SHIP, "SYS Sinister and Gauche", false, CrewXPLevel.ELITE);
		api.addToFleet(FleetSide.PLAYER, "ms_enlil_Standard", FleetMemberType.SHIP, "SYS Hopeful Acquaitance", false, CrewXPLevel.ELITE);
		api.addToFleet(FleetSide.PLAYER, "ms_sargasso_Balanced", FleetMemberType.SHIP, "SYS Inverterate", false, CrewXPLevel.ELITE);
