package data.missions.walkinthepark;
...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "Two New Boxer-class destroyers");
		api.setFleetTagline(FleetSide.ENEMY, "A small Tri-Tachyon detachment");
		
		// These show up as items in the bulleted list under 
		// "Tactical Objectives" on the mission detail screen
		api.addBriefingItem("Defeat all enemy forces");
		api.addBriefingItem("The RNS Torque and the RNS Beeswax must survive");
		api.addBriefingItem("Be careful of the mobility of the Tri-Tachyon fleet");
		
		// Set up the player's fleet.  Variant names come from the
		// files in data/variants and data/variants/fighters
		api.addToFleet(FleetSide.PLAYER, "junk_pirates_boxer_Fighter", FleetMemberType.SHIP, "RNS Torque", true);
		api.addToFleet(FleetSide.PLAYER, "junk_pirates_boxer_Fighter", FleetMemberType.SHIP, "RNS Beeswax", false);
		...
		api.defeatOnShipLoss("RNS Torque");
		...
		api.addObjective(minX + width * 0.4f, minY + height * 0.35f, 
		...
		api.addPlanet(minX + width * 0.6f, minY + height * 0.2f, 300f, "cryovolcanic", 300f);
	}
