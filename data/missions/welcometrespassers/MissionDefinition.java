package data.missions.welcometrespassers;
...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.ENEMY, "Hegemony Trespassers");
		
		// These show up as items in the bulleted list under 
		// "Tactical Objectives" on the mission detail screen
		api.addBriefingItem("Disable the Onslaught HSS Spaceboy");
		...
		// api.addToFleet(FleetSide.PLAYER, "junk_pirates_boxer_Standard", FleetMemberType.SHIP, "RNS Dreamboat", true);
