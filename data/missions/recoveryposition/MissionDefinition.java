package data.missions.recoveryposition;
...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "HSS Marksman and Bolstered Scouting detachment");
		api.setFleetTagline(FleetSide.ENEMY, "Unknown Pirate forces");
		
		// These show up as items in the bulleted list under 
		// "Tactical Objectives" on the mission detail screen
		api.addBriefingItem("Defeat all enemy forces");
		api.addBriefingItem("All Hegemony ships are expendable");
		api.addBriefingItem("Watch out for salvaged Onslaught weaponry");
		...
		api.addToFleet(FleetSide.ENEMY, "junk_pirates_sickle_Strike", FleetMemberType.SHIP, false);
		// api.addToFleet(FleetSide.ENEMY, "hound_Assault", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.ENEMY, "junk_pirates_hammer_Assault", FleetMemberType.SHIP, false);
		...
		api.addObjective(minX + width * 0.4f, minY + height * 0.6f, 
		...
		api.addPlanet(minX + width * 0.50f, minY + height * 0.50f, 200f, "star_yellow", 200f);
	}
