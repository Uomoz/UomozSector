...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.addToFleet(FleetSide.PLAYER, "ms_enlil_Attack", FleetMemberType.SHIP, "SYS Leitmotif", true, CrewXPLevel.ELITE);
		api.addToFleet(FleetSide.PLAYER, "ms_enlil_PD", FleetMemberType.SHIP, "SYS Standoffish", false, CrewXPLevel.ELITE);
		api.addToFleet(FleetSide.PLAYER, "ms_enlil_AF", FleetMemberType.SHIP, "SYS Alder", false, CrewXPLevel.ELITE);
