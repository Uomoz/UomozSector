...
public class UsSFleetInteractionDialogPluginImpl implements InteractionDialogPlugin {
	...
	private UsSFleetEncounterContext context = new UsSFleetEncounterContext();
			...
			new FleetMemberPickerListener() {
				public void pickedFleetMembers(List<FleetMemberAPI> members) {
					if (members != null && !members.isEmpty()) {
						UsSBattleAutoresolverPluginImpl resolver = new UsSBattleAutoresolverPluginImpl(playerFleet, otherFleet);
